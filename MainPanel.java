...
//        return q;
     ...
     * format. First it will display backup cells and then the current cells.
     * Backup cells are what you revert to when you press Undo.
     */
...
//            _r = origR;
    ...
    /**
     * Revert back to the previous iteration, which we have saved in
     * _backupCells.
     */
    public void undo() {
    ...
    /**
     * Loop through the entire array and reset each of the Cells in the
     * MainPanel.
     */
    public void clear() {
        for (int j = 0; j < _size; j++) {
